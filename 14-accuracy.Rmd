...
tab=data.frame(tab) 
rownames(tab)<-c("KCHI", "CHI", "FEM", "MAL", "SPEECH", "AVE")
...
Here is the Table for LENA performance on the exact same data: FAKE NUMBERS!!! page 22

```{r, echo=FALSE}

tabLENA=NULL
tabLENA$precision<-c(62.37, 46.77, 70.30, 39.52, 77.03, 59.20)
tabLENA$recall<-c(76.67, 25.78, 57.87, 46.92, 79.89, 57.42)
tabLENA$fscore<-c(68.78, 33.24, 63.48, 42.91, 78.43, 57.37)
tabLENA=data.frame(tabLENA) 
rownames(tabLENA)<-c("KCHI", "CHI", "FEM", "MAL", "SPEECH", "AVE")
...
<!--insert same info as in 13 chart but for all corpora (only yellow & purple bars)--> page 24
