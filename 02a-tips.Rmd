...
So, for instance, if you use a regular t-shirt you might spend maybe 4\$, and use a paperclip to attach the device to the t-shirt. This way, the family can keep the t-shirt and it’s only worth 4\$ for you. 
    
<!--3. how stable the performance of the device is given variation in temperature and humidity, and how easily one can recharge the recorder. TO ADD --> 
