...
In field sites, we used to recommend USB devices. This is because they are very cheap and don’t look very fancy, so the chances you get them stolen are very low. But most importantly, they don’t require much energy. You can charge them with a simple solar panel, for instance. 
...
However, please note that recent generations of USBs have proved to be very low quality, breaking up the audio in subparts. So buy well in advance so you can test each unit. Alternatively, you can invest in other devices (see the hardware section.)

The risk of theft of the recorders is low (depending on your location) - No recorders have ever been lost during fieldwork. On the exception of the US, where families tend to lose them in larger houses with a single case of theft directly from in the mail (someone accessed the package that was delivered to them). In conclusion, there are equal if not worse risks in more developed environments. 
There is risk of damage when people are in water, reminder to leave the recorders outside.
...
Kids can be VERY particular about what type of clothing they will or will not wear so it’s helpful to anticipate various options (shirts, vests, different animal designs on them, etc.).

Regarding the size of clothing, some children in developing countries are smaller than what is considered the « norm » in NA/Europe (for nutritional reasons among other socio-cultural factors). Moreover, in colder climates, the shirt will often be worn over a long sleeve shirt or sweater. If they are spending time outside, children tend to wear more layers than a simple shirt. 
...
An affordable alternative is to make your own shirts with pockets, since the LENA shirts are expensive and the corresponding clip can sometimes bother children around their neck. For example, for infants, some people cut off the bottom part of onesies. 
...
- [Example USB](https://www.amazon.fr/SMARTEX-Enregistreur-vocal-heures-Audio/dp/B018U60YYM/)  please note we have not tested this one! so do buy a sample one before you buy them in bulk. There may be others that are shipped to your location.
- Casillas, M. & Cristia, A. (2019). A step-by-step guide to collecting and analyzing long-format speech environment (LFSE) recordings, Collabra. [link](https://online.ucpress.edu/collabra/article-abstract/5/1/24/113018) 
- [A step-by-step guide to collecting and analyzing long-format speech environment (LFSE) recordings](https://online.ucpress.edu/collabra/article-abstract/5/1/24/113018) 
- [Appendix to that guide](https://ucp.silverchair-cdn.com/ucp/content_public/journal/collabra/5/1/10.1525_collabra.209/3/collabra-5-209-s1.pdf?Expires=1633594641&Signature=qXacU15L3LUAaJ6CQKPyRT-EsW-UqBjJChdbm7fV~3XL6AKuqoqHHQmCTgW4kq84BwU1qqp-aAifxumuROnCH8lKVpQs9k4IbtRqDwt0ztu5Z2eMYifvwCgLypw94Vt13D3wcnvvRI7CcskqWBWuRP0CwSpN9BTsCpheUfk0wBAoherLQvhQbaRzVvn6TDQhAFNfDa7Azyvnw8kBaX2JQx1EkigRgDtCJ54B36-0wD7JscvrVkWJ3GJXni-AuxuXihf4ezjSdsTg8xYOCcTcf4JJBrQjFL-2LSLiRfo2OgMFxw6w~96F~NoLhWeT9P7~KhLpOJ6aC0tTr-QuYsIB3Q__&Key-Pair-Id=APKAIE5G5CRDK6RD3PGA)
