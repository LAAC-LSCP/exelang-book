...
Of course, the answer to each of this question depends on your research goals, and \ref(@humanannotation-faqs) provides clues to some of them.

Most often, the amount of audio that can be annotated is heavily constrained by the availailty of human resources, and can be considered fixed.
...
Below, we show that the choice of the sampling strategy may have a significant impact.
