...
```{r key-decisions-flowchart,  fig.align = 'center', fig.cap = "Flowchart of key decisions for those considering a study with LFSE recordings. Those researchers whose path ends with an “X” should instead consider non-LFSE approaches.", echo = FALSE}
...
- [This book](https://bookdown.org/alecristia/exelang-book/)
